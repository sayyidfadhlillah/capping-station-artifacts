...
<AdapterType Comment="" Name="AGripper">
  ...
  <InterfaceList>
    <EventInputs>
      ...
      <Event Comment="action performed succesfully" Name="done" Type="Event"/>
    ...
    <EventOutputs>
      ...
      <Event Comment="perform grip movement" Name="grip" Type="Event"/>
      <Event Comment="perform release movement" Name="release" Type="Event"/>
    </EventOutputs>
    <InputVars/>
    <OutputVars/>
  </InterfaceList>
