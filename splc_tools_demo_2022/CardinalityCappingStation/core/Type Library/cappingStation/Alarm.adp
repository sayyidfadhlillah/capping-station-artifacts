...
<AdapterType Comment="Adapter Interface" Name="Alarm">
  <Identification Standard="61499-1"/>
  <VersionInfo Author="az" Date="2018-07-12" Version="1.0"/>
  <InterfaceList>
    <EventInputs>
      <Event Comment="Raise an alarm" Name="raise" Type="Event"/>
    </EventInputs>
    <EventOutputs>
      <Event Comment="Alarm acknoledgement" Name="ack" Type="Event"/>
    </EventOutputs>
    <InputVars/>
    <OutputVars/>
  </InterfaceList>
