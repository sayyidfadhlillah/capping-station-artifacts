...
<AdapterType Comment="Adapter Interface" Name="ABlocker">
  <Identification Standard="61499-1"/>
  <VersionInfo Author="az" Date="2018-08-20" Version="1.0"/>
  <InterfaceList>
    <EventInputs>
      <Event Comment="Request from Socket" Name="error" Type="Event"/>
      <Event Comment="" Name="palletteWaiting" Type="Event"/>
      <Event Comment="Response from Socket" Name="pallettePassed" Type="Event"/>
    </EventInputs>
    <EventOutputs>
      <Event Comment="Confirmation from Plug" Name="block" Type="Event"/>
      <Event Comment="Indication from Plug" Name="letPassSingle" Type="Event"/>
      <Event Comment="" Name="letPass" Type="Event"/>
    </EventOutputs>
    <InputVars/>
    <OutputVars/>
  </InterfaceList>
