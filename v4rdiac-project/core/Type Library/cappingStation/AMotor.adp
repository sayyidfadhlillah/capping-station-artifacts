...
<AdapterType Comment="Adapter Interface" Name="AMotor">
  <Identification Standard="61499-1"/>
  <VersionInfo Author="az" Date="2018-07-17" Version="1.0"/>
  <InterfaceList>
    <EventInputs>
      <Event Comment="request performed succesfully" Name="done" Type="Event"/>
      <Event Comment="request could not be performed" Name="error" Type="Event"/>
    </EventInputs>
    <EventOutputs>
      <Event Comment="turn the motor on" Name="turnOn" Type="Event"/>
      <Event Comment="turn the motor off" Name="turnOff" Type="Event"/>
    </EventOutputs>
    <InputVars/>
    <OutputVars/>
  </InterfaceList>
