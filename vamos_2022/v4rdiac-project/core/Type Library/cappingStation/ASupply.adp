...
<AdapterType Comment="Adapter Interface" Name="ASupply">
  <Identification Standard="61499-1"/>
  <VersionInfo Author="az" Date="2018-07-17" Version="1.0"/>
  <InterfaceList>
    <EventInputs>
      <Event Comment="Request from Socket" Name="resetO" Type="Event"/>
      <Event Comment="Response from Socket" Name="partReady" Type="Event"/>
      <Event Comment="" Name="partReleased" Type="Event"/>
      <Event Comment="" Name="error" Type="Event"/>
    </EventInputs>
    <EventOutputs>
      <Event Comment="Confirmation from Plug" Name="reset" Type="Event"/>
      <Event Comment="Indication from Plug" Name="providePart" Type="Event"/>
      <Event Comment="" Name="releasePart" Type="Event"/>
    </EventOutputs>
    <InputVars/>
    <OutputVars/>
  </InterfaceList>
